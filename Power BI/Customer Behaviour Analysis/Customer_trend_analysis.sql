...
-- Calculate the total revenue generated by male vs female customers

SELECT gender, SUM(purchase_amount) AS Revenue
from customer
GROUP BY gender;

-- Which customer used a discount yet spent more than the average purchase amount?
...
SELECT shipping_type, ROUND(AVG(purchase_amount :: numeric),2) AS "Average Purchase Amounts"
FROM customer
